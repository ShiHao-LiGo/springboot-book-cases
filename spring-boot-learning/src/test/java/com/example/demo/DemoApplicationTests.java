...
class DemoApplicationTests {
    ...
    //去掉mail这个字段，检查实际数据库中的字段名和模型字段名是否一致
    @Test
    public void testRepository(){
        ...
        //通过name查询数据
        List<AyUser> userList2 = ayUserService.findByName("aa");
        System.out.println("findByName() :" + userList2.size());
        Assert.isTrue(userList2.get(0).getName().equals("aa"),"data error!");
        //通过name模糊查询数据
        List<AyUser> userList3 = ayUserService.findByNameLike("%a%");
        System.out.println("findByNameLike() :" + userList3.size());
        Assert.isTrue(userList3.get(0).getName().equals("aa"),"data error!");
        //通过id列表查询数据
...
//        System.out.println("page findAll():" + userList5.getTotalPages() + "/" + userList5.getSize());
    ...
    public void testMybatis(){
        AyUser ayUser = ayUserService.findByNameAndPassword("aa", "123456");
